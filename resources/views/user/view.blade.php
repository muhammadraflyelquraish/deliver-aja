        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5><button class="btn btn-primary btn-sm" data-toggle="modal" data-mode="add" data-target="#ModalAddEdit"><i class="fa fa-plus-square mr-1"></i> Tambah Pengguna [F2]</button></h5>
                </div>
            ...
            <form id="formAddEdit" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control" id="email" name="email" tabindex="2" required maxlength="200">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="phone_number" name="phone_number" tabindex="5" maxlength="30">
    ...
    $(document).ready(function() {
        ...
        $('#ModalAddEdit').on('shown.bs.modal', function(e) {
            ...
            if (button.data('mode') == 'edit') {
                ...
                $('#formAddEdit').attr('action', '{{ route("users.store") }}/' + id).attr('method', 'PATCH')
                ...
                modal.find('#email').val(closeTr.find('td:eq(2)').text())
                modal.find('#role').val(closeTr.find('td:eq(3)').text())
        ...
        $("#formAddEdit").validate({
            messages: {
                ...
                email: {
                    ...
                    minlength: "Email minimal 5 karakter"
                },
                password: {
